...
public class ProducerClient {
	...
	public static String Access_Key_Secret = "l9Jrn7psS8zleTh201KECbVyMJsP07";

	public static String Access_Key_ID = "LTAI0v9Qe1cua2hX";

	public static void main(String[] args) {
		Properties properties = new Properties();
		properties.put(PropertyKeyConst.ProducerId, "PID_TEST_CDD_1");
		properties.put(PropertyKeyConst.AccessKey, ProducerClient.Access_Key_ID);
		properties.put(PropertyKeyConst.SecretKey, ProducerClient.Access_Key_Secret);
